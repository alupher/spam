...
Our initial results using the Pegasos SVM solver included in ScalaNLP were disappointing. The 
...
51\%. Table \{tab:svmfeats} provides a list of top features for the bag-of-words and expert 
...
collected around the beginning of January. 
...
The ham message collection methodology used in this project may have been flawed, leading questionable 
