...
This project examines in detail the types of malicious and benign
...
InterPals, which has over 1.3 million active members. This data
includes a corpus of over a 100 million private messages and another 2 
...
We then test the classifiers on new site data to evaluate their performance.
...
We implement the detection algorithms using Matlab, ScalaNLP, LibSVM, and Spark, an in-memory distributed computing framework designed for machine learning and iterative computation.
