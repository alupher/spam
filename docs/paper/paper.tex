...
social attributes of spam and ham on video SNSs (in this case, YouTube), including video 
view counts, comment counts and user public profile attributes. They then use a 
support vector machine (SVM) for classification, yielding 96\% accuracy in detecting 
